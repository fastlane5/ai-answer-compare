...
import { Download, Save, FileText, AlertCircle, Check, X, Plus, Trash2, Eye, Edit2, ArrowLeft, ArrowRight, Files, Code } from 'lucide-react';
    ...
    <div className="flex flex-col h-screen bg-gray-50 font-sans">
      ...
      <div className="bg-white border-b shadow-sm p-3 flex flex-wrap items-center gap-4 text-sm z-10">
        ...
        <div className="flex-1 text-right text-xs text-gray-500">
          단축키: <kbd className="bg-gray-100 border p-1 rounded">Ctrl</kbd> + <kbd className="bg-gray-100 border p-1 rounded">Alt</kbd> + <kbd className="bg-gray-100 border p-1 rounded">◀ / ▶</kbd> (탭 전환)
        </div>
      </div>
      ...
      {/* 3. 현재 탭 액션(도구) 바 */}
      {activeTab && (
        <div className="bg-white border-b px-4 py-2 flex flex-wrap items-center justify-between text-sm shadow-sm z-10">
